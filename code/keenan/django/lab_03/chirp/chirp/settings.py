...
# this import os needed for the os.path.join below and the staticfiles_dirs updates
# import os
...
SECRET_KEY = 'django-insecure-hy6!z)o8f2#if7%9dnwk*mk+y0^6+(&s)3nfp206o&ko(3u+i)'
