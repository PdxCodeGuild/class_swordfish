#Mon 4:20 All the Things aka with notes (working when turned in)
...
while True:
    ...
    #print(contact_list)
        ...
        # record = get_record(contact_list, headers) #run function
        # remove_row = int(1-{len(record)}) - 1
        # contact_list.remove(record[remove_row])
        #remove_contact = int(input()
        #contact_list.remove(contact)
        ...
        # for i in contact_list: #another way to specify each list in the file
